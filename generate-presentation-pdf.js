...
async function generatePDF() {
  try {
    ...
    const markdownContent = fs.readFileSync('JobPortal_8_Page_Presentation.md', 'utf8');
    ...
    await page.pdf({
      path: 'JobPortal_8_Page_Presentation.pdf',
      format: 'A4',
    ...
    console.log('✅ PDF generated successfully: JobPortal_8_Page_Presentation.pdf');
    console.log('📁 File saved in the root directory');
    
    // Check if file exists and show size
    const stats = fs.statSync('JobPortal_8_Page_Presentation.pdf');
